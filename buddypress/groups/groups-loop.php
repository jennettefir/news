...
<?php if ( bp_has_groups( bp_ajax_querystring( 'groups' ) ) ) : ?>
	...
	<ul id="groups-list" class="item-list item-list-s" aria-live="assertive" aria-atomic="true" aria-relevant="all">
		...
		<li <?php bp_group_class(); ?>>
			<?php if ( ! bp_disable_group_avatar_uploads() ) : ?>
				<div class="item-avatar">
					<a href="<?php bp_group_permalink(); ?>"><?php bp_group_avatar( 'type=full&width=90&height=90' ); ?></a>
				</div>
			<?php endif; ?>
			...
			<div class="action">
				...
				<div class="meta g1-meta">

					<span class="bp-group-status bp-group-status-<?php bp_group_status(); ?>"><?php bp_group_type(); ?></span> / <?php bp_group_member_count(); ?>
