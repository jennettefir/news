...
<div id="buddypress" class=" <?php if ( 'standard' !== bimber_get_theme_option( 'bp', 'enable_sidebar' ) ) { echo sanitize_html_class( 'bp-register-full' ); }?>">
	...
	<div class="page" id="register-page">
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<div class="register-section" id="basic-details-section">
				...
				<h2 class="g1-gamma g1-gamma-1st"><?php _e( 'Account Details', 'buddypress' ); ?></h2>
			...
			<?php if ( bp_is_active( 'xprofile' ) ) : ?>
				...
				<div class="register-section" id="profile-details-section">
					...
					<h2 class="g1-gamma g1-gamma-1st"><?php _e( 'Profile Details', 'buddypress' ); ?></h2>
						...
						<div<?php bp_field_css_class( 'editfield' ); ?>>
							...
							if ( bp_current_user_can( 'bp_xprofile_change_field_visibility' ) ) : ?>
								<p class="field-visibility-settings-toggle" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id() ?>"><span id="<?php bp_the_profile_field_input_name(); ?>-2">
									...
									<button type="button" class="visibility-toggle-link g1-button-subtle g1-button g1-button-xs" aria-describedby="<?php bp_the_profile_field_input_name(); ?>-2" aria-expanded="false"><?php _ex( 'Change', 'Change profile field visibility level', 'buddypress' ); ?></button>
								</p>
								...
								<div class="field-visibility-settings" id="field-visibility-settings-<?php bp_the_profile_field_id() ?>">
									...
									<button type="button" class="field-visibility-settings-close g1-button-subtle g1-button g1-button-xs"><?php _e( 'Close', 'buddypress' ) ?></button>
